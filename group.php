...
<body>
    ...
    <h1 style="text-align: center; padding-bottom: 300px; color: gray; border-radius: 20px;">Kamingsun</h1>
    <nav class="navbar">
        <a href="index.php">
        ...
        <a href="group.php">
            <span class="material-icons active"><i class="fas fa-users"></i></span>
            <span>Group</span>
        </a>
        <a href="search.php">
